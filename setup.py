...
setup(
    ...
    install_requires=['pyyaml', 'beautifulsoup4', 'urllib3', 'selenium', 'configparser', 'tools', 'pip>=18.1', 'Pillow', 'requests>=2.21', 'pyautogui', 'gspread', 'google-api-python-client', 'oauth2client', 'pymongo', 'dill', 'IPython'],
    extras_require={
