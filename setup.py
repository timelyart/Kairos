...
setup(
    ...
    install_requires=['pyyaml', 'beautifulsoup4', 'urllib3', 'selenium>=3.141,<4', 'configparser', 'tools', 'pip', 'Pillow', 'requests', 'gspread', 'google-api-python-client', 'oauth2client', 'pymongo', 'dill', 'numpy',
                      'fastnumbers', 'psutil', 'Cython', 'tqdm'],
    extras_require={
